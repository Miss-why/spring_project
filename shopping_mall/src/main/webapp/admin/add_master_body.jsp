    ...
    <section class="admin_bgcolor_add">
        <div class="admin_login_add">
            <ul>
                ...
                <li>
                <input type="text" name=auserid class="add_input1" placeholder="생성할 관리자 아이디를 입력하세요">
                <button type="button"  class="btn_button">중복체크</button>
                </li>
                <li>
                    <input type="text" name=auserpass class="add_input1" placeholder="접속할 패스워드를 입력하세요">
                    <input type="text" name=passck class="add_input1" placeholder="동일한 패스워드를 입력하세요">
                </li>
                <li class="font_color1">관리자 기본정보 입력</li>
                <li>
                    <input type="text" name=ausername class="add_input1" placeholder="담당자 이름을 입력하세요">
                </li>
                <li>
                ...
                <li>
                    <select class="add_select1" name=dept>
                    ...
                    <select class="add_select1" name=positon>
